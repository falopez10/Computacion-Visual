...
const sphereArrays = createSphere(0.4, 6, 6);
const cylinderArrays = createCylinder(0.4, 0.8, 30, 1, false, false);
const coneArrays = createTruncatedCone(0.4, 0.0, 0.8, 12, 1, true, true);
console.log(sphereArrays);
console.log(cylinderArrays);
console.log(coneArrays);
main();
